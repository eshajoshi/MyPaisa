...
public class CoreDataController {
    ...
    lazy private var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle(for: CoreDataController.self).url(forResource: "MyPaisa", withExtension: "momd")!
    ...
    lazy var persistentStoreContainer: NSPersistentContainer = {
        ...
        let container = NSPersistentContainer(name: "MyPaisa", managedObjectModel: self.managedObjectModel)
